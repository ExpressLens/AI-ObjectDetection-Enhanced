...
#     """
#     # raise Exception("SID: prep_pointcloud function shouldn't be used anymore")
#     t = time.time()
...
#     # SID: I think refernce_detections is always None.
#     assert reference_detections is None, "SID: I think referece_detections is always None"
...
#     # SID: I think remove_outside_points is always False.
#     assert not remove_outside_points, "SID: I think remove_outside_points is always False"
...
def anno_dict_to_gt_dict(anno_dict):
    """
    Args:
        anno_dict: dictionary of annotations provided by dataset.
    Returns:
        gt_dict: dict{"gt_boxes", "gt_names", "gt_importance", "gt_difficulty"}
    """
    gt_dict = {
        "gt_boxes": anno_dict["boxes"],
        "gt_names": anno_dict["names"],
...
def prep_add_targets(example,
                     gt_dict,
                     target_assigner):
    """
    Create targets and add them to example.
    ...
    Returns:
        gt_dict: same dict as before but with additional keys:
                 "gt_names", "labels", "reg_targets", "importance"
    """
