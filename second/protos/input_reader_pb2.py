...
_INPUTREADER_PREPROCESS = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='min_num_of_points_in_gt', full_name='second.protos.InputReader.Preprocess.min_num_of_points_in_gt', index=17,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='random_flip_x', full_name='second.protos.InputReader.Preprocess.random_flip_x', index=18,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='random_flip_y', full_name='second.protos.InputReader.Preprocess.random_flip_y', index=19,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='sample_importance', full_name='second.protos.InputReader.Preprocess.sample_importance', index=20,
...
_INPUTREADER_CUMLCWRAPPER_SPARSIFYRETURN = _descriptor.Descriptor(
  name='SparsifyReturn',
  full_name='second.protos.InputReader.CumLCWrapper.SparsifyReturn',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='max_height', full_name='second.protos.InputReader.CumLCWrapper.SparsifyReturn.max_height', index=0,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='pos_intensity_thresh', full_name='second.protos.InputReader.CumLCWrapper.SparsifyReturn.pos_intensity_thresh', index=1,
      number=2, type=13, cpp_type=3, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='neg_subsampling_rate', full_name='second.protos.InputReader.CumLCWrapper.SparsifyReturn.neg_subsampling_rate', index=2,
...
_INPUTREADER_CUMLCWRAPPER = _descriptor.Descriptor(
  name='CumLCWrapper',
  full_name='second.protos.InputReader.CumLCWrapper',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='lc_policy', full_name='second.protos.InputReader.CumLCWrapper.lc_policy', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='lc_horizon', full_name='second.protos.InputReader.CumLCWrapper.lc_horizon', index=1,
      number=2, type=13, cpp_type=3, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='init_lidar_num_beams', full_name='second.protos.InputReader.CumLCWrapper.init_lidar_num_beams', index=2,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='sparsify_return', full_name='second.protos.InputReader.CumLCWrapper.sparsify_return', index=3,
  ...
  nested_types=[_INPUTREADER_CUMLCWRAPPER_SPARSIFYRETURN, ],
  enum_types=[
  ],
  options=None,
  is_extendable=False,
...
_INPUTREADER = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='cum_lc_wrapper', full_name='second.protos.InputReader.cum_lc_wrapper', index=5,
  ...
  nested_types=[_INPUTREADER_DATASET, _INPUTREADER_PREPROCESS, _INPUTREADER_CUMLCWRAPPER, ],
  enum_types=[
  ],
  options=None,
  is_extendable=False,
...
_INPUTREADER_CUMLCWRAPPER_SPARSIFYRETURN.containing_type = _INPUTREADER_CUMLCWRAPPER
_INPUTREADER_CUMLCWRAPPER.fields_by_name['sparsify_return'].message_type = _INPUTREADER_CUMLCWRAPPER_SPARSIFYRETURN
_INPUTREADER_CUMLCWRAPPER.containing_type = _INPUTREADER
...
_INPUTREADER.fields_by_name['cum_lc_wrapper'].message_type = _INPUTREADER_CUMLCWRAPPER
...
InputReader = _reflection.GeneratedProtocolMessageType('InputReader', (_message.Message,), dict(
  ...
  CumLCWrapper = _reflection.GeneratedProtocolMessageType('CumLCWrapper', (_message.Message,), dict(

    SparsifyReturn = _reflection.GeneratedProtocolMessageType('SparsifyReturn', (_message.Message,), dict(
      DESCRIPTOR = _INPUTREADER_CUMLCWRAPPER_SPARSIFYRETURN,
      __module__ = 'second.protos.input_reader_pb2'
      # @@protoc_insertion_point(class_scope:second.protos.InputReader.CumLCWrapper.SparsifyReturn)
      ))
    ,
    DESCRIPTOR = _INPUTREADER_CUMLCWRAPPER,
    __module__ = 'second.protos.input_reader_pb2'
    # @@protoc_insertion_point(class_scope:second.protos.InputReader.CumLCWrapper)
    ))
  ,
...
_sym_db.RegisterMessage(InputReader.CumLCWrapper)
_sym_db.RegisterMessage(InputReader.CumLCWrapper.SparsifyReturn)
